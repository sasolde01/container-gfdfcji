...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gfdfcji.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gfdfcji.containers.anotherwebservice.com/
...
```
git clone git@github.com:sasolde01/container-gfdfcji.git
cd container-gfdfcji
```
...
```
docker attach container-gfdfcji
```
